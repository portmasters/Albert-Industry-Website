		...
		<div class="content">
			<div class="courseListBx">
				...
				<div id="addACoursebx">
					...
					<input name="inputCourseName" placeholder="Enter any subjects here!" maxlength="18" type="text" />
			...
			<div class="courseRightBx">
				...
				<p>
				Download <a href="../validation/download.php?path=../images/guide/guide.rar" target="_blank">here</a> for a brief tutorial.
				<br>
				Download <a href="../validation/download.php?path=../images/guide/guide.rar" target="_blank">here</a> to see an entire demostration of how this website work.
				</p>
